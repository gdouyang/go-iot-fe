...
`,
  ...
  codeTip: [
    ...
    // session
    { caption: 'session.ReadDiscreteInputs()', meta: 'session', value: 'session.ReadDiscreteInputs(startingAddress, length)' },
    { caption: 'session.ReadCoils()', meta: 'session', value: 'session.ReadCoils(startingAddress, length)' },
    { caption: 'session.ReadInputRegisters()', meta: 'session', value: 'session.ReadInputRegisters(startingAddress, length)' },
    { caption: 'session.ReadHoldingRegisters()', meta: 'session', value: 'session.ReadHoldingRegisters(startingAddress, length)' },
